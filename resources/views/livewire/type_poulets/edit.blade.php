<div class="col-md-12">
    <div class="card mb-4">
        <div class="card-body">
            <div class="card-title mb-3">{{ __('Modification type poulet')}}</div>
            <form>
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        <label for="firstName2">{{ __('Libelle type poulet')}}</label>
...
<div class="overlay">
    ...
    <div class="alert alert-warning text-center">
        ...
        <p class="text-black">Vous etes sure de valider la modification poulet</p>
        <p class="text-center">
