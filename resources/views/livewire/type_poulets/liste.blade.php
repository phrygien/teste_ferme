    ...
    <table class="table custom-table m-0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-primary" wire:click.prevent="editType({{ $type->id }})"  wire:loading.attr="disabled" wire:target="editType({{ $type->id }})">
                    ...
                    <button class="btn btn-danger" wire:click.prevent="confirmerDelete({{ $type->id }})"  wire:loading.attr="disabled" wire:target="confirmerDelete({{ $type->id }})">
